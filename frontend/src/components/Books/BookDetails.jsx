...
//         <h1 className="text-3xl font-semibold text-center mb-8">{book.title}</h1>
//         <div className="flex flex-col sm:flex-row items-center sm:items-start">
//           <img
//             src={book.coverImage}
//             alt={book.title}
//             className="w-24 sm:w-1/4 h-auto mb-4 sm:mb-0 sm:mr-4"
//           />
//           <div className="flex flex-col text-left w-full sm:w-2/3">
//             <p><strong>Genre:</strong> {book.genre}</p>
//             <p><strong>Price:</strong> ₹{book.price}</p>
//             <p className="mt-4 text-justify w-auto">
...
// import { MdAddShoppingCart } from 'react-icons/md'; // Import shopping cart icon
...
//             Want to Read
//           </button>
//           <button className="w-full px-4 py-2 bg-gradient-to-r from-[#FF00D3] to-[#76E6FF] rounded-3xl text-white font-medium flex items-center justify-center">
...
//                 <FaStar
//                   key={index}
//                   className={`w-7 h-7 ${index < 3 ? 'text-yellow-400' : 'text-gray-300'}`}
//                 />
//               ))}
//             </div>
